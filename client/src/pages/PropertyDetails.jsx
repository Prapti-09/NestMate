    ...
    <div className="property-details-page">
        ...
        <aside className="details-sidebar">
           <div className="card booking-sticky-card">
              ...
              <div className="cta-group">
                 <button className="btn btn-primary w-full pulse-animation">Request Booking</button>
      ...
      <style>{`
        ...
        @media (max-width: 1024px) {
           ...
           .details-layout { grid-template-columns: 1fr; gap: 4rem; }
           .details-sidebar { display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; }
